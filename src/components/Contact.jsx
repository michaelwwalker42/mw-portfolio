    ...
    <div name='contact' className='w-full h-screen bg-[#0d1d34] flex justify-center items-center p-4'>
      <form method='POST' action="https://getform.io/f/fe4ee176-7f9c-4c7f-ba1c-b712a9805f15" className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'>
          ...
          <p className='text-gray-300 py-4'>Submit the form below or email me at 
            <span className='cursor-pointer text-[#e5dcc5] hover:underline hover:font-bold'>
              <a href='mailto:michaelwwalker42@gmail.com'> michaelwwalker42@gmail.com </a>
            </span>
          </p>
        </div>
