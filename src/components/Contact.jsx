      ...
      <form method='POST' action="https://getform.io/f/fe4ee176-7f9c-4c7f-ba1c-b712a9805f15" className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'>
          ...
          <ul className='list-disc p-4 text-lg'>
            {/* Email */}
            <li className='cursor-pointer text-[#e5dcc5] hover:underline hover:font-bold mt-3'>
              <a href='mailto:michaelwwalker42@gmail.com'>
                Email
              </a>
            </li>
            {/* LinkedIn */}
            <li className='cursor-pointer text-[#e5dcc5] hover:underline hover:font-bold'>
              <a href='https://www.linkedin.com/in/michael-walker-67971b221/'>
                LinkedIn
              </a>
            </li>
            {/* GitHub */}
            <li className='cursor-pointer text-[#e5dcc5] hover:underline hover:font-bold'>
              <a href='https://github.com/michaelwwalker42'>
                GitHub
              </a>
            </li>
          </ul>
